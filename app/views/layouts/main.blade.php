        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/">Shomogro</a>
                </div>
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#">Products I added</a></li>
                                <li><a href="#">Products I sold</a></li>
                                <li><a href="#">Products I bought</a></li>
                            </ul>
                        </li>
        ...
        <div id="wrapper">
                    ...
                    <div id="user-menu">
                        ...
                        @if(Auth::check())
                            <nav class="dropdown">
                                <ul>
                                    <li>
                                        <a href="#">{{ HTML::image('img/user-icon.gif', Auth::user()->mobileNumber) }} {{ Auth::user()->mobileNumber }} {{ HTML::image('img/down-arrow.gif', Auth::user()->mobileNumber) }}</a>
                                        <ul>
                                            @if(Auth::user()->isActivated == 0)
                                               <!-- <li>{{ HTML::link('admin/categories', 'Manage Categories') }}</li>-->
                                                <li>{{ HTML::link('/products', 'Manage Products') }}</li>
                                            @endif
            ...
            <footer>
                ...
                <section class="clearfix">
                    <div id="copyright">
                        <div id="logo">
                            <a href="#"><span id="logo-accent">Shomogro Bangladesh</a>
                        </div><!-- end logo -->
                        <p id="store-desc">The first social marketplace in the world</p>
                        <p id="store-copy">&copy; 2015 Shomogro</p>
                    </div><!-- end copyright -->
                   <!-- <div id="connect">
