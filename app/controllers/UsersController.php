...
class UsersController extends BaseController {
	...
	public function postSignin() {
		if (Auth::attempt(array('mobileNumber'=>Input::get('mobileNumber'), 'password'=>Input::get('password')))) {
			return Redirect::to('/')->with('message', 'Thanks for signing in');
		}

		return Redirect::to('users/signin')->with('message', 'Your mobile/password combo was incorrect');
	}
